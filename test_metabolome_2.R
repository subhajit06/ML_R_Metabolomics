...
AP_compund_name_list_0 = df_compound[id_list_1, 2]
...
id_list_1 = as.integer(unlist(lapply(res1$features, function(z){str_split(z,"_")[[1]][2]})))
PP_compund_name_list_0 = df_compound[id_list_1, 2]

cat('dim X2: ', dim(X2)," length Y2: ", length(Y2),'\n')

colnames(X2) = as.character(seq(1,dim(X2)[2]))

PP_compund_name_list_arr = NULL
i = 0
for(a in seq(0,1.0,by=0.1)){
  a2 = a
  i = i+1
  ...
  PP_compund_name_list_arr[[i]] = PP_compund_name_list
}
############

saveRDS(AP_compund_name_list_0, file="./AP_compund_name_list_0_caret.Rds")
saveRDS(AP_compund_name_list_arr, file="./AP_compund_name_list_arr.Rds")

saveRDS(PP_compund_name_list_0, file="./PP_compund_name_list_0_caret.Rds")
saveRDS(PP_compund_name_list_arr, file="./PP_compund_name_list_arr.Rds")
